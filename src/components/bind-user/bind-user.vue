	...
	<section style="width:100%">
		<el-form :inline="true" :model="editForm" class="demo-form-inline">
		  <el-form-item label="手机号:">
		    <el-input v-model="editForm.tel" type="number" placeholder="要绑定的手机号"></el-input>
		  </el-form-item>
		  <el-form-item>
  	...
  	<el-table
	    ...
	    <el-table-column
	      ...
	      <template scope="scope">
	        ...
	        <span v-show="bindStatus !== 0">已绑定</span>
	        <el-button v-show="bindStatus == 0" @click="bindShop(scope.row.id, scope.row)" type="primary" size="small" v-text="">绑定</el-button>
	      </template>
	    </el-table-column>
	  </el-table>
...
<script type="text/ecmascript-6">
	...
	import { getMemberList, pay, getUserBalance, searchUser, bindToShop } from 'api/api'
  ...
  export default {
      ...
      handleCurrentChange(val) {
        ...
        this.getMemberListEnv(params)
      	...
      	let params = {
      		params: {
	      		user_mobile: this.editForm.tel
      		}
      	}
      	this.searchUserEnv(params)
      }
		}
  }
</script>
