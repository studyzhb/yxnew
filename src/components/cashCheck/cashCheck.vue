	...
	<section style="width:100%">
	    	...
	    	<el-table
			    ...
			    <el-table-column
			      ...
			      <template scope="scope">
			        ...
			        <el-button v-if="scope.row.status === '已审核' " type="warning" size="small" @click="refuseEnv(scope.row)" >拒绝</el-button>
			        <el-button v-if="scope.row.status === '已审核' " type="success" size="small" @click="examineOkEnv(scope.row)" >打款</el-button>
	  ...
	  <el-dialog title="提现审核" :visible.sync="dialogFormVisible">
		  <el-form :model="form" class="formBox">
		  	<p style="font-size:15px;line-height:1.7;">提现: <span style="font-size:19px;margin-left:4px;" v-text="form.draw"></span></p>
		  	<p style="font-size:15px;line-height:1.7;">提现后: <span style="font-size:19px;margin-left:4px;" v-text="form.balance"></span></p>
		  	<p style="font-size:15px;line-height:1.7;">手机号: <span  style="font-size:19px;margin-left:4px;"v-text="form.user_mobile"></span></p>
		  	<p style="font-size:15px;line-height:1.7;">姓名: <span style="font-size:19px;margin-left:4px;" v-text="form.real_name"></span></p>
		  	<p style="font-size:15px;line-height:1.7;">身份证号: <span style="font-size:19px;margin-left:4px;" v-text="form.id_card"></span></p>
		  	<p style="font-size:15px;line-height:1.7;">银行: <span style="font-size:19px;margin-left:4px;"v-text="form.card_name"></span></p>
		  	<p style="font-size:15px;line-height:1.7;">银行卡号: <span style="font-size:19px;margin-left:4px;" v-text="form.card_num"></span></p>
		  </el-form>
