<template>
	<section style="width:100%">
		...
		<el-row style="font-size: 14px;color: rgb(25, 23, 23);background: rgb(123, 191, 241);padding: 10px;border-radius: 2px;">
		  <el-col :span="3"><div class="grid-content bg-purple">总计：{{reportList.total}}</div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple-light">收益中：{{reportList.st_1}}笔</div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple">兑换中：{{reportList.st_2}}笔</div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple-light">兑换完成：{{reportList.st_3}}笔</div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple">已提货：{{reportList.tk_ok}}笔</div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple-light">未提货：{{reportList.tk_no}}笔</div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple-light">已回购：{{reportList.tk_3}}笔</div></el-col>
		</el-row>
	    ...
	    <el-tab-pane label="兑换中" name="second">
			    ...
			    <el-table-column
			      ...
			      label="货物状态">
			      <template scope="scope">
			      	<span v-if="scope.row.takeDelivery === 2">已提货</span>
			      	<el-button @click="takeGoods(scope.row)" type="text" size="small" v-if="scope.row.takeDelivery === 1">提货</el-button>
			        <!-- <el-button @click="takeGoods(scope.row)" type="text" size="small" v-text="scope.row.status === '已发货' ? '提货' : ''"></el-button> -->
			      </template>
			    </el-table-column>
			  </el-table>
